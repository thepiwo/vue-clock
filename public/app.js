...
//Taken from https://github.com/for-GET/know-your-http-well/json/status-codes.json
var statusCodes = [
    {
        "code": "100",
        "phrase": "Continue",
...
function fetchStatusCode(code) {
    var statusCode = statusCodes.filter(function (status) { return status.code === code; });
    return statusCode.length === 1 ? statusCode[0] : null;
}

var Clock = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"clock"},[_c('div',{staticClass:"clock__hours"},[_c('span',{staticClass:"clock__hourtime"},[_vm._v(_vm._s(_vm.hourtime))]),_vm._v(" "+_vm._s(_vm.hours))]),_c('div',{staticClass:"clock__minutes"},[_vm._v(_vm._s(_vm.minutes))]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.statusPhrase !== ''),expression:"statusPhrase !== ''"}],staticClass:"clock__statusphrase"},[_vm._v(_vm._s(_vm.statusPhrase))])])},staticRenderFns: [],
    data: function data() {
        return {
            hours: '',
            minutes: '',
